      ...
      <section className="min-h-[90vh] md:pt-12 pt-2 px-4 lg:px-20 flex flex-col   text-gray-800 dark:text-white">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 py-10 relative">
          ...
          <div className="lg:col-span-1 space-y-10 text-lg">
            <h1 className="md:text-3xl text-2xl lg:text-4xl font-bold font-lato text-blue-500 mb-5 text-center w-fit after:content-[' '] relative after:absolute after:-bottom-3.5 after:left-0 after:h-1.5 after:w-[60%] after:rounded-full after:bg-purple-400 dark:after:bg-purple-600">
              {state?.title}
            </h1>
